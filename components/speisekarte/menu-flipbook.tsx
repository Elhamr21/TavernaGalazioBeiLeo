      ...
      >
        ...
        >
          {pages.map((page, idx) => (
            <div
              key={idx}
              className="w-full h-full p-4 sm:p-8 bg-white text-foreground flex flex-col overflow-y-auto relative"
...
function BookPage({ page, onDishClick }: BookPageProps) {
  if (page.type === "cover") {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center gap-4 sm:gap-6">
        <div className="w-20 sm:w-32 h-20 sm:h-32 relative">
          <Image
            src="/images/logo.png"
            alt="Taverna Galazio Logo"
            fill
        ...
        <p className="text-sm sm:text-base text-muted-foreground italic mt-2 sm:mt-4">
  ...
  if (page.type === "end") {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center gap-4 sm:gap-6">
        <div className="w-12 sm:w-20 h-12 sm:h-20 rounded-full border-2 border-accent/30 mb-2 sm:mb-4" />
        <h1 className="font-serif text-lg sm:text-3xl font-semibold text-foreground whitespace-pre-line">
          {page.title}
        </h1>
